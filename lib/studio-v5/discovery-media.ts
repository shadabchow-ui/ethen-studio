...
export const DISCOVERY_MEDIA: readonly DiscoveryMediaItem[] = [
  ...
  { id: "influencer-skincare-01", type: "video", src: "/studio-v5/showcase/influencer-skincare-01.mp4", poster: "/studio-v5/showcase/influencer-skincare-01.jpg", width: 720, height: 1280, aspectRatio: "9:16", durationSeconds: 8, sections: ["home-video", "spotlight-influencer"], title: "Skincare talk-to-camera reel", categories: ["fashion", "character"], placeholder: false, sourceType: "licensed-showcase", ...INFLUENCER },
  { id: "marketing-beauty-01", type: "video", src: "/studio-v5/showcase/marketing-beauty-01.mp4", poster: "/studio-v5/showcase/marketing-beauty-01.jpg", width: 1280, height: 720, aspectRatio: "16:9", durationSeconds: 8, sections: ["home-video", "spotlight-marketing"], title: "Beauty close-up with studio headphones", categories: ["product", "advertising"], placeholder: false, sourceType: "licensed-showcase", ...MARKETING },
