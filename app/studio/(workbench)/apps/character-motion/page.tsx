 ...
 */
export default async function CharacterMotionAppRoute({ searchParams }: { searchParams: Promise<{ prompt?: string; projectId?: string }> }) {
  const params = await searchParams;
  const query = new URLSearchParams({ mode: "image-to-video", preset: "character-motion" });
