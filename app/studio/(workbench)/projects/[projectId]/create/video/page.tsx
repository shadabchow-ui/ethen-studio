 ...
 */
export default async function StudioProjectCreateVideoRoute({ params }: { params: Promise<{ projectId: string }> }) {
  const { projectId } = await params;
  redirect(`/studio/create/video?projectId=${encodeURIComponent(projectId)}`);
}
