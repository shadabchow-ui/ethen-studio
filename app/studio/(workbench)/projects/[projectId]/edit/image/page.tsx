 ...
 */
export default async function StudioProjectEditImageRoute({ params }: { params: Promise<{ projectId: string }> }) {
  const { projectId } = await params;
  redirect(`/studio/create/edit?projectId=${encodeURIComponent(projectId)}`);
}
